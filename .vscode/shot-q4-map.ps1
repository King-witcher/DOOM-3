param([string]$Map = "game/mcc_landing", [int]$Seconds = 45)
...
$argv = @("+set","fs_basepath","C:\code\id\DOOM-3\run\q4","+set","fs_game","q4base","+set","fs_savepath","C:\code\id\DOOM-3\run\q4save","+set","si_pure","0","+set","fs_restrict","0","+set","com_allowConsole","1","+set","logFile","2","+set","r_fullscreen","0","+set","image_usePrecompressedTextures","0","+set","r_windowX","2000","+set","r_windowY","60","+set","g_skill","1","+map","$Map")
...
$p.Refresh()
$shot = "C:\code\id\DOOM-3\.vscode\q4map.png"
