...
// RAVEN BEGIN
// jscott: new proc format (Quake 4 v37)
...
// forward declarations for Quake 4 v37 types passed/returned across the boundary
...
// RAVEN BEGIN
// mwhitlock: Xenon texture streaming (_XENON not defined in this build -> member omitted)
// RAVEN END
...
// RAVEN BEGIN
// mwhitlock: Dynamic memory consolidation (_RV_MEM_SYS_SUPPORT not defined -> Flush omitted)
// RAVEN END
...
// mwhitlock: Xenon texture streaming (_XENON not defined in this build -> StreamAreaTextures/ClearAreaTextureStreamer omitted)
// RAVEN END
